            ...
            foreach ($shipping_addresses as $index => $shipping_address) {
                ...
                <section class="shipping_address">
                    ...
                    <div class="form-group">
                        ...
                        <?= html_text("shipping_addresses[$index][recipient_name]", 'maxlength="255" placeholder="Leave empty to use your name"') ?>
                    ...
                    <div class="form-group">
                        ...
                        <?= html_text("shipping_addresses[$index][address_phone_number]", 'maxlength="20" placeholder="Leave empty to use your phone number"') ?>
...
<button class="button" data-get="../profile.php">Back</button>
